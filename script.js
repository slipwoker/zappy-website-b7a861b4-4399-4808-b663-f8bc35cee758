...
document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateField(field) {
            ...
            if (field.hasAttribute('pattern') && value) {
                ...
                if (!pattern.test(value)) {
                    showError(field, field.getAttribute('data-error') || 'Invalid format');
                    return false;
                }
            }
    ...
    if (animatedElements.length > 0) {
        ...
        animatedElements.forEach(function(element) {
            ...
            if (currentOpacity === '0' || element.classList.contains('fade-in') || element.hasAttribute('data-animate')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b7a861b4-4399-4808-b663-f8bc35cee758',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b7a861b4-4399-4808-b663-f8bc35cee758';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b7a861b4-4399-4808-b663-f8bc35cee758';
